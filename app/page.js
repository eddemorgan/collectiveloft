        ...
        const TcContent = () => (
          <div style={{fontFamily:'var(--sans)'}}>
            ...
            <Sec num="3" title="Subscription & Billing">
              ...
              <Sub>3.1 Billing</Sub><P>By subscribing, you authorize Collective Loft and its payment processors (currently Stripe) to automatically charge your selected payment method on a recurring monthly basis at the then-current subscription rate.</P>
              ...
              <Sub>3.4 Payment Processor Terms</Sub><P>Payment processing is handled by Stripe and subject to Stripe's own terms of service and privacy policy. Collective Loft is not responsible for payment processing errors, disputes, or issues that arise from Stripe's systems.</P>
            </Sec>
            ...
            <Sec num="11" title="Email Communications"><P>By creating an account, you consent to receive transactional emails including account confirmations, password resets, collaboration term notifications, studio activity alerts, rating prompts, billing notifications, and platform policy changes.</P></Sec>
            ...
            <Sec num="15" title="Privacy & Data"><P>Your use of the Platform is governed by our Privacy Policy at collectiveloft.com/privacy.</P></Sec>
