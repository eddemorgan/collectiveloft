...
const PUBLIC_PATHS = ['/', '/login', '/subscribe', '/signup', '/onboarding', '/browse', '/how-it-works', '/morgan-collective', '/guide', '/Collective_Loft_User_Guide.pdf', '/collective-loft-user-guide.html']
