...
const STEPS = [
  {
    ...
    what: 'You join, then build a profile around your discipline and what you’re making right now.',
    why: <>Membership is the front door to a space built and protected for creatives. <b>It’s what keeps the people who exploit creatives out.</b> Once you’re in, your “right now” is what makes the right people find you.</>,
  },
  {
    n: '02',
    title: 'Find your people',
    what: 'Discover and match with collaborators, scored on discipline, skill, and what you’re both looking for.',
    why: <>No more cold DMs into the void. The platform surfaces the people who actually fit what you’re making, and shows you <b>why</b> each one is a match.</>,
  },
  {
    n: '03',
    title: 'Agree on real terms',
    protect: 'Protected on purpose',
    what: 'Before any work begins, you negotiate compensation, rights, and timeline. All of it on record.',
    why: <>This is the protection. <b>No more handshake deals that fall apart.</b> Both sides know exactly what was agreed before a single note or brushstroke.</>,
  },
  {
    n: '04',
    title: 'Open a Loft Studio',
    what: 'A shared workspace opens the moment you agree. Brief, files, milestones, and messages, all in one place.',
    why: <>Real infrastructure for the work, not a group chat that gets lost. <b>The Studio is where it actually gets made.</b></>,
  },
  {
    n: '05',
    title: 'Finish, and build your reputation',
    what: 'You complete the work as agreed, then you rate each other.',
    why: <>Every finished collaboration makes you more trusted, more visible, more sought-after. <b>Being great to work with becomes something people can see</b>, and it compounds.</>,
  },
]
  ...
  return (
    <div className={styles.page}>
      ...
      <header className={styles.hero}>
        ...
        <h1 className={styles.title}>From first hello to <em>finished work.</em></h1>
        <p className={styles.lede}>Collective Loft turns “we should work together” into something real, with the right people, real terms, and a place to actually make it. Here’s the whole journey.</p>
      </header>
        ...
        {STEPS.map(s => (
          <div key={s.n} className={styles.step}>
            ...
            <div className={styles.stepBody}>
              {s.protect && <span className={styles.protect}>{s.protect}</span>}
