...
const FAQS = [
  ...
  { q: 'How much does Collective Loft cost?', a: <>Joining is <b>free</b>. Membership is <b>$10 per month</b> after a 7-day free trial, and enrolled students pay nothing. What the $10 buys is the right to start things: posting a brief, and reaching out first. The subscription gets you full access to everything: Discover, Collab Briefs, discipline matching, Collab Terms, and the Loft Studio.</> },
  { q: 'Is there a free trial?', a: <>Yes. Your first <b>7 days are free</b>. You won&rsquo;t be charged until the trial ends, and you can cancel anytime before then. After the trial, membership is $10 per month.</> },
  { q: 'Is there a free version?', a: <>Yes, and a free member is a <b>real member</b>. You get a profile, you appear in Discover and Discipline Matching, other members can reach you, and when they do you can agree terms, work in the Loft Studio, get paid, and build a rating from finished work. It never expires and never needs a card. Membership at $10 a month buys the right to <b>start</b> things: posting a Collab Brief, and reaching out to someone first.</> },
  { q: 'What happens if I cancel?', a: <>You keep everything through the end of the month you already paid for, and then you are a free member again. Your profile, portfolio, rating and history all stay. Any collaboration already running carries on to the end, and any brief you already posted stays live. You just cannot start a new one until you subscribe again.</> },
  { q: 'Are students free?', a: <>Yes. Enrolled students pay nothing. Sign up with your <b>school email address</b>, we send a six-digit code to that address, you enter it, and you get a free year with full access and no card. Re-verify the same way each year for as long as you are a student. This works in countries where school email domains are reserved for accredited institutions, which covers the United States, the United Kingdom, Australia, Japan, India, South Africa and around thirty others. If your school sits on an ordinary domain, send us a note below.</> },
  { q: 'What if I want my money back?', a: <>You have <b>14 days</b> from any payment to request a full refund, for any reason. Refunds are issued by Paddle, our merchant of record. Ask them directly at paddle.net, or send us a note below and we will pass it on.</> },
  { q: 'Why does Collective Loft charge a subscription?', a: <>Because free platforms attract people who aren&rsquo;t serious. The $10 a month keeps this a professional environment, a room where everyone has skin in the game, agreements are in writing before work starts, and <b>your creative work is protected from day one</b>. The cost is the filter that keeps the people who exploit creatives out.</> },
