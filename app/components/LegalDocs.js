...
export const TermsDoc = () => (
  <div style={{fontFamily:'var(--sans)'}}>
    ...
    <Sec num="3" title="Subscription & Billing">
      ...
      <Sub>3.1 Billing</Sub><P>New paid memberships begin with a free trial of 7 days. No charge is made during the trial, and cancelling before it ends costs you nothing. When the trial ends, or immediately if you subscribe without one, you authorize our merchant of record, Paddle.com Market Ltd, to automatically charge your selected payment method on a recurring monthly basis at the then-current subscription rate. The advertised price is tax inclusive: Paddle is the seller of record for Collective Loft memberships and handles applicable sales tax, VAT, and GST out of that amount.</P>
