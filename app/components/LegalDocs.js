...
export const TermsDoc = () => (
  <div style={{fontFamily:'var(--sans)'}}>
    ...
    <Sec num="3" title="Subscription & Billing">
      ...
      <Sub>3.1 Billing</Sub><P>By subscribing, you authorize our merchant of record, Lemon Squeezy, LLC, to automatically charge your selected payment method on a recurring monthly basis at the then-current subscription rate. Lemon Squeezy is the seller of record for Collective Loft memberships and handles applicable sales tax, VAT, and GST.</P>
      ...
      <Sub>3.4 Payment Processor Terms</Sub><P>Membership billing is handled by Lemon Squeezy as merchant of record and is subject to Lemon Squeezy's terms of service and privacy policy. Payments between members for collaborations are processed by Stripe through Stripe Connect and are subject to Stripe's terms. Collective Loft is not responsible for payment processing errors, disputes, or issues arising from either provider's systems.</P>
    </Sec>
...
export const PrivacyDoc = () => (
  <div style={{fontFamily:'var(--sans)'}}>
    ...
    <Sec num="3" title="How We Share Your Information">
      ...
      {[['Supabase','Database, auth, storage, realtime'],['Vercel','Platform hosting and deployment'],['Lemon Squeezy','Membership billing (merchant of record)'],['Stripe','Collaboration payments and member payouts'],['Resend','Transactional email delivery'],['Google Analytics','Platform usage analytics (anonymized)']].map(([p,pu]) => (
    ...
    <Sec num="4" title="Payment Data"><P>Collective Loft does not store your full payment card information. Membership billing is handled by Lemon Squeezy as merchant of record; collaboration payments are handled by Stripe.</P></Sec>
