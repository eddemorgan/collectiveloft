  ...
  <div style="max-width:560px;margin:0 auto;padding:44px 24px;">
    ...
    <div style="background:#F0ECE3;border:1px solid rgba(26,24,20,0.1);padding:36px 32px;">
      ...
      <p style="font-size:15px;color:rgba(26,24,20,0.75);margin:0 0 28px;line-height:1.7;">
        ${greeting} Collective Loft is a professional network where creatives find each other, agree on real terms, and make things together. No feeds to perform for. No bosses. Collaborators.
      </p>
    ...
    <p style="font-size:13px;color:rgba(26,24,20,0.55);text-align:center;margin:28px 0 6px;line-height:1.6;">
      Questions? Just reply to this email. A real person reads it.
    </p>
    <p style="font-size:12px;color:rgba(26,24,20,0.4);text-align:center;margin:0 0 8px;line-height:1.6;">
      Built in Chicago, with care, by Edde and Stephanie Morgan.
    </p>
