...
export const TermsDoc = () => (
  <div style={{fontFamily:'var(--sans)'}}>
    ...
    <Sec num="3" title="Membership & Billing">
      <Sub>3.0 Membership Types</Sub><P>Collective Loft has a free membership and a paid membership, and both are full memberships. A free member has a profile, appears in Discover and Discipline Matching, may be contacted by other members, and may answer Collab Briefs, agree Collab Terms, work in a Loft Studio, receive payment for collaborations, and build a public rating from completed work. Free membership does not expire and requires no payment method.</P><P>Paid membership adds the right to start things: posting a Collab Brief, and initiating Collab Terms with another member. Student membership under Section 3.6 and any complimentary membership we grant carry the same rights as paid membership for as long as they last. When a paid membership ends for any reason, including cancellation, non-payment, refund, or the expiry of a complimentary or student period, the account becomes a free membership. It is not suspended, closed, or emptied. Collaborations already underway continue to completion with full access for both parties, and Collab Briefs already posted remain live.</P>
      <div style={{background:'rgba(201,168,76,0.1)',border:'0.5px solid rgba(201,168,76,0.25)',borderRadius:'3px',padding:'0.6rem 1rem',marginBottom:'0.75rem'}}><span style={{fontFamily:'var(--serif)',fontSize:'1.2rem',color:'var(--gold)',fontWeight:700}}>$10 USD / month</span></div>
      <Sub>3.1 Billing</Sub><P>This section applies only to paid membership. New paid memberships begin with a free trial of 7 days. No charge is made during the trial, and cancelling before it ends costs you nothing. When the trial ends, or immediately if you subscribe without one, you authorize our merchant of record, Paddle.com Market Ltd, to automatically charge your selected payment method on a recurring monthly basis at the then-current subscription rate. The advertised price is tax inclusive: Paddle is the seller of record for Collective Loft memberships and handles applicable sales tax, VAT, and GST out of that amount.</P>
      <Sub>3.2 Renewal & Cancellation</Sub><Ul items={['A free trial converts to a paid monthly subscription automatically unless you cancel before it ends','Subscriptions automatically renew each month unless canceled before the next billing cycle','You may cancel at any time through your account settings','Upon cancellation, your access continues through the end of your current paid billing period, and the account then becomes a free membership under Section 3.0 rather than being closed']}/>
