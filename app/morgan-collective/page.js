...
import styles from './morgan-collective.module.css'
...
const DIVISIONS = [
  { name: 'Platform', color: '#B8922E', status: 'live', desc: 'The professional network. Discovery, matching, terms, and the Loft Studio. Live now.' },
  { name: 'Studios', color: '#A0522D', status: 'planned', desc: 'Physical creative and recording space, in the cities where creatives gather.' },
  { name: 'Records', color: '#3D4F5C', status: 'planned', desc: 'An artist-first label. Fairer splits, shorter contracts, more ownership kept by the artist.' },
  { name: 'Publishing', color: '#5C6B3A', status: 'planned', desc: 'Protecting and monetizing the work creatives make across the ecosystem.' },
]

export default function MorganCollectivePage() {
  return (
    <div className={styles.page}>
      <nav className={styles.nav}>
        <div className={styles.navInner}>
          <Link href="/" className={styles.brand}>
            ...
            <span>
              <span className={styles.wm}>Morgan Collective <em>Group</em></span>
              <span className={styles.tag}>Infrastructure for Creative Individuals</span>
            </span>
          </Link>
          <Link href="/" className={styles.navBack}>&larr; Collective Loft</Link>
        </div>
      </nav>
      ...
      <section className={styles.section}>
        <div className={styles.secEyebrow}>Leadership</div>
        <h2 className={styles.secTitle}>The team behind it.</h2>
        <div className={styles.founders}>
          <div className={styles.founder}>
            <div className={styles.fInitials}>EM</div>
            <div className={styles.fName}>Edde Morgan</div>
            <div className={styles.fRole}>Chief Executive Officer &amp; Founder</div>
            <p className={styles.fBio}>An IT and data professional building the infrastructure the creative world lacked. Responsible for vision, product strategy, and platform development, building the flagship without outside development cost.</p>
          </div>
          <div className={styles.founder}>
            <div className={styles.fInitials}>SM</div>
            <div className={styles.fName}>Stephanie Morgan</div>
            <div className={styles.fRole}>Chief Operating Officer</div>
            <p className={styles.fBio}>A technology and product specialist responsible for operational execution, product roadmap, and infrastructure. The operational discipline behind building multiple companies the right way.</p>
          </div>
        </div>
      </section>

      <section className={styles.section}>
        <div className={styles.secEyebrow}>The architecture</div>
        <h2 className={styles.secTitle}>One parent. A growing ecosystem.</h2>
        <div className={styles.secBody}>
          <p>Morgan Collective Group owns every company beneath it. Each operates under its own Collective brand, sharing one mission but serving a distinct need. <b>Collective Loft is the flagship, the foundation everything else grows from.</b></p>
        </div>

        <div className={styles.arch}>
          <div className={`${styles.node} ${styles.nodeParent}`}>
            <div className={styles.nodeParentName}>Morgan Collective Group</div>
            <div className={styles.nodeParentSub}>Parent Company &middot; Est. 2026</div>
          </div>
            ...
            <div className={styles.divisions}>
              {DIVISIONS.map(d => (
                <div key={d.name} className={styles.division}>
                  ...
                  <div className={styles.divDesc}>{d.desc}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <p className={styles.archNote}>The platform finds the talent. The studio gives them a home. The label releases their work. Publishing protects what they create. One mission, many doors.</p>
      </section>

      <section className={styles.section}>
        <div className={styles.secEyebrow}>Why we exist</div>
        <h2 className={styles.secTitle}>The creative class is underserved.</h2>
        <div className={styles.secBody}>
          <p>Creatives have long been asked to surrender control, equity, and dignity just to access the tools to build a career. Morgan Collective Group exists to change that, one company at a time.</p>
        </div>
        <div className={styles.stats}>
          <div className={styles.stat}>
            <div className={styles.statNum}>165M</div>
            <div className={styles.statLabel}>independent creative professionals worldwide, the fastest-growing part of the workforce</div>
          </div>
          <div className={styles.stat}>
            <div className={styles.statNum}>Underserved</div>
            <div className={styles.statLabel}>the least well-served segment by professional infrastructure</div>
          </div>
          <div className={styles.stat}>
            <div className={styles.statNum}>Built for them</div>
            <div className={styles.statLabel}>infrastructure designed around how creative collaboration actually works</div>
          </div>
        </div>
      </section>

      <section className={styles.close}>
        <h2 className={styles.closeH}>It starts with <em>Collective Loft.</em></h2>
        <p className={styles.closeSub}>The foundation is live. The rest is being built with the same commitment to the people it serves.</p>
        <Link href="/" className={styles.btnPrimary}>Explore Collective Loft</Link>
      </section>

      <footer className={styles.foot}>
        <div className={styles.footInner}>
          <div className={styles.footRow}>
            <div className={styles.fine}>&copy; 2026 Morgan Collective Group LLC</div>
            ...
            <div className={styles.fine}>Chicago, Illinois</div>
          </div>
        </div>
      </footer>
    </div>
