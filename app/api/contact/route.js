      ...
      html: `
        ...
        <body style="margin:0;padding:0;background:#F0ECE3;font-family:Arial,sans-serif;color:#1A1814;">
          <div style="max-width:560px;margin:0 auto;padding:32px 24px;">
            <p style="font-size: 0.75rem;letter-spacing:0.14em;text-transform:uppercase;color:#B8922E;margin:0 0 16px;">New Help Request</p>
            ...
            <p style="font-size: 0.75rem;color:#7A7060;margin:0;">Reply directly to this email to respond to ${safe(name)}.</p>
          </div>
        </body>
        </html>
      `,
