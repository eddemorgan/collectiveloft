  ...
  if (submitted) return (
    <div className={styles.successState}>
      ...
      <div className={styles.successActions}>
        <Link href={`/profile/${partner?.firstname?.toLowerCase()}-${partner?.lastname?.toLowerCase()}`} className={styles.btnViewProfile}>
      ...
      <div className={styles.ratingForm}>
          ...
          <div className={styles.starDisplay}>
            <div className={styles.starRow}>
              ...
              <div className={styles.starLabel}>
                {STAR_LABELS[displayStars] || 'Tap to rate'}
              </div>
            </div>
          </div>
        ...
        <div className={styles.formSection}>
          ...
          <div className={styles.reviewField}>
            ...
            <textarea
              maxLength={600}
              placeholder={`Working with ${partnerFirst} felt like a genuine creative partnership. She listened closely to what the work needed, not just what I asked for…`}
              value={review}
        ...
        <div className={styles.submitArea}>
          ...
          <div className={styles.submitNote}>
            You can submit this review at any time from your My Studios page. {partnerFirst} will also be submitting a review of you — you won't see each other's reviews until both are submitted, so neither influences the other.
          </div>
        </div>
